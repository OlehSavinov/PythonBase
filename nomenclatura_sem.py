...
codes_to_remove = [
    ...
    'NBUC-000135','NOGI-000164','NSAL-000245','NMAL-000005','NCHO-000016',
    'NVIO-000010','NPER-000023','NCIK-000006','NPEL-000017','NBAZ-000001',
    'NVER-000013','NMEZ-000002'
]
...
replacements = {
    ...
    ' кл':'','тейшен':'тейшн','експоуз':'експоз',
...
def match_code(nom_text, culture, uktzed):
    ...
    elif uktzed in ['1209300000', '1209']:
        sub = sub[sub['Субкатегорія'].isin(['Овочеві', 'Квіти'])]
...
# "Внутрішній код" — останньою колонкою
if 'Внутрішній код' in df_nom.columns:
    ordered = [c for c in df_nom.columns if c != 'Внутрішній код'] + ['Внутрішній код']
    df_nom = df_nom[ordered]
